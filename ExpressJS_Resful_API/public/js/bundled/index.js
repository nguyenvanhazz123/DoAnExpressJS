...
/* eslint-disable import/no-extraneous-dependencies */ /* eslint-disable node/no-unsupported-features/es-syntax */ /* eslint-disable no-undef */ var _polyfill = require("@babel/polyfill");
var _leaflet = require("./leaflet");
var _login = require("./login");
var _signup = require("./signup");
var _updateSettings = require("./updateSettings");
var _strtipe = require("./strtipe");
...
if (bookBtn) bookBtn.addEventListener("click", (e)=>{
    ...
    (0, _strtipe.bookTour)(tourId);
});

},{"@babel/polyfill":"dTCHC","./leaflet":"xvuTT","./login":"7yHem","./updateSettings":"l3cGY","./strtipe":"3aSh6","./signup":"fNY2o"}],"dTCHC":[function(require,module,exports) {
"use strict";
...
/* eslint-disable node/no-unsupported-features/es-syntax */ /* eslint-disable import/prefer-default-export */ /* eslint-disable no-var */ /* eslint-disable no-undef */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
/* eslint-disable import/no-extraneous-dependencies */ /* eslint-disable import/prefer-default-export */ /* eslint-disable node/no-unsupported-features/es-syntax */ /* eslint-disable no-restricted-globals */ /* eslint-disable no-alert */ /* eslint-disable no-undef */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const login = async (email, password)=>{
    ...
    try {
        ...
        if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "\u0110\u0103ng nh\u1EADp th\xe0nh c\xf4ng!");
            window.setTimeout(()=>{
                location.assign("/");
            }, 1500);
        }
...
const logout = async ()=>{
    try {
        ...
        if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "\u0110\u0103ng xu\u1EA5t th\xe0nh c\xf4ng");
            window.setTimeout(()=>{
                location.reload(true);
            }, 1000);
        }
    } catch (error) {
        (0, _alerts.showAlert)("error", "L\u1ED7i khi \u0111\u0103ng xu\u1EA5t. Vui l\xf2ng th\u1EED l\u1EA1i sau");
    }
};
...
/* eslint-disable no-restricted-globals */ /* eslint-disable no-undef */ /* eslint-disable node/no-unsupported-features/es-syntax */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const updateSettings = async (data, type)=>{
    try {
        ...
        if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", `${type.toUpperCase()} c\u{1EAD}p nh\u{1EAD}t th\xe0nh c\xf4ng!`);
            window.setTimeout(()=>{
                location.reload(true);
            }, 1500);
        }
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3aSh6":[function(require,module,exports) {
/* eslint-disable no-use-before-define */ /* eslint-disable import/prefer-default-export */ /* eslint-disable node/no-unsupported-features/es-syntax */ /* eslint-disable no-undef */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "bookTour", ()=>bookTour);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
const stripe = Stripe("pk_test_51OvqClBGQOPwYmHCTVR6GfmhkUqjWJEiPlobeKKlKpCLTbeywgcy9hrIf4NxKj7Nv2D6Ck0P9xumlr8v9M5CqWTf00RSNF4dMn");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","axios":"jo6P5","./alerts":"6Mcnf"}],"fNY2o":[function(require,module,exports) {
/* eslint-disable import/no-extraneous-dependencies */ /* eslint-disable import/prefer-default-export */ /* eslint-disable node/no-unsupported-features/es-syntax */ /* eslint-disable no-restricted-globals */ /* eslint-disable no-alert */ /* eslint-disable no-undef */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const signup = async (name, email, password, passwordConfirm)=>{
    ...
    try {
        ...
        if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "\u0110\u0103ng k\xfd th\xe0nh c\xf4ng!");
            window.setTimeout(()=>{
                location.assign("/");
            }, 1000);
        }
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kx4kz","f2QDv"], "f2QDv", "parcelRequire7e89")
